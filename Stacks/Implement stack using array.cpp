...
Testcase 3: According to the given input , firstly no elements were there so after performing pop operation output will be -1 -1 and after performing all the push and pop operation , output wil be -1 -1 40 68 23 51 73.
